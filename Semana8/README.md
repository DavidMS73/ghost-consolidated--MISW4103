...
1. Pruebas E2E -> nuevas pruebas desarrolladas en Puppeteer-Cucumber para la Semana 8. Para ver el listado remitirse a la [wiki](https://github.com/DavidMS73/ghost-consolidated-MISW4103/wiki#semana-8E), en el enlace "Nuevos escenarios E2E" de la Semana 8. Para su ejecución revisar el README de la carpeta [Pruebas E2E](https://github.com/DavidMS73/ghost-consolidated-MISW4103/tree/main/Semana8/Pruebas%20E2E/README.md), tener en cuenta el apartado "Semana 8".
2. ResemblePuppeteer -> nuevas pruebas de regresión visual desarrolladas. Para su ejecución revisar el README de la carpeta [ResemblePuppeteer](./ResemblePuppeteer/README.md).
...
Para las otras entregas por favor remitirse a la [wiki apartado Semana 8](https://github.com/DavidMS73/ghost-consolidated-MISW4103/wiki#semana-8).
