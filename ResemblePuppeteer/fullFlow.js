...
async function executeTest() {
  ...
  for (let feat = 0; feat < features.length; feat++) {
    const featurePathv1 = `${sourceDirsOutput[0] + versions[0]}/${
      features[feat]
    }`;
    const featurePathv2 = `${sourceDirsOutput[1] + versions[1]}/${
      features[feat]
    }`;
    ...
    for (let scenario = 0; scenario < scenarios.length; scenario++) {
      const escenarioPathv1 = `${sourceDirsOutput[0] + versions[0]}/${
        features[feat]
      }/${scenarios[scenario]}`;
      const escenarioPathv2 = `${sourceDirsOutput[1] + versions[1]}/${
        features[feat]
      }/${scenarios[scenario]}`;
      ...
      for (let step = 0; step < mx_length; step++) {
        ...
        //Comparar imagenes
        const stepPathv1 = `${sourceDirsOutput[0] + versions[0]}/${
          features[feat]
        }/${scenarios[scenario]}/${stepsv1[step]}`;
        const stepPathv2 = `${sourceDirsOutput[1] + versions[1]}/${
          features[feat]
  ...
  fs.writeFileSync(`./results_full_flow/report.html`, report);
